@messages  You are an autonomous senior Flutter engineer working inside an EXISTING production Flutter project.
...
7. Example success JSON?
{
    ...
    "data": {
        ...
        "first_page_url": "https://greenhub.sa-fvs.com/api/v1/chat?page=1",
        "from": 1,
        "last_page": 1,
        "last_page_url": "https://greenhub.sa-fvs.com/api/v1/chat?page=1",
        "links": [
            {
                "url": null,
            ...
            {
                "url": "https://greenhub.sa-fvs.com/api/v1/chat?page=1",
                "label": "1",
                "page": 1,
                "active": true
            },
        ...
        "next_page_url": null,
        "path": "https://greenhub.sa-fvs.com/api/v1/chat",
        "per_page": 20,
        "prev_page_url": null,
        "to": 1,
        "total": 1
...
messages_screen.dart#L53
 
                    "name": "سائق اختبار كامل",
 message: 'هل يمكننا الاتفاق على سعر أخر؟',
  "message": "11مرحباً، مريم",
دى تبقى اخر رسالة فى list messages
ازا وجد 10 رسايل تبقى دى اخر رسالة فى list 

messages_screen.dart#L55
 
                        "created_at": "2026-03-15T12:10:48.000000Z",


messages_screen.dart#L56-57
 
بناء على     "is_read": false,

message_item_widget.dart#L44
