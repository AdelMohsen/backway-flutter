@about  You are an autonomous senior Flutter engineer working inside an EXISTING production Flutter project.
...
7. Example success JSON?
{
    ...
    "data": {
        "type": "about",
        "title": "نبذة عنا",
        "body": "<ul><li><font color=\"#000000\" style=\"background-color: rgb(255, 255, 0);\">اكتب نبذة عن التطبيق هنا...</font></li></ul>"
    }
}
