@reharge_balance   You are an autonomous senior Flutter engineer working inside an EXISTING production Flutter project.
...
inside this module @reharge_balance
...
7. Example success JSON?
{
    ...
    "data": {
        "transaction": {
            "transaction_id": "TXN-20260311-3C452124",
            "user_id": 339,
            "order_id": null,
            "type": "deposit",
            "amount": "50.00",
            "balance_before": "1276.00",
            "balance_after": "1326.00",
            "status": "completed",
            "description": "Deposit via credit_card",
            "updated_at": "2026-03-11T13:53:08.000000Z",
            "created_at": "2026-03-11T13:53:08.000000Z",
            "id": 12
        },
        "new_balance": "1326.00"
    }
...
9. Post-success behavior?
   ...
   - Navigate?
   - Save cache?
Show message  navigate to    final cubit = NavbarLayoutCubit.get(context);
              CustomNavigator.pop();
...
formfileds_recharge_widget.dart#L29-41
 
but note 

formfileds_recharge_widget.dart#L43-96
 
this send amount [50, 100, 200, 300] only 
    "payment_method": "credit_card"
 this 

formfileds_recharge_widget.dart#L118-140
 
هنثبت حاليا credit_card 
القيمة دى 

recharge_balance_screen.dart#L56
