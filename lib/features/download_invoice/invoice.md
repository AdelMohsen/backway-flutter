...
/customer/orders/443/invoice?lang={{lang}}
...
invoice.php{
    ...
    "data": {
        "invoice_number": 443,
        "order_number": "ORD-20260312-BC017F",
        ...
        "labels": {
            ...
            "send_via_email": "إرسال عبر البريد",
            "download_pdf": "تحميل ملف PDF",
            "qr_code": "https://greenhub.sa-fvs.com/assets/dashboard/Ellipse%2030.png"
        },
        "amounts": {
            "subtotal": 100,
            "vat_rate": 0.15,
            "vat_amount": 15,
            "total_including_vat": 115
        },
        "currency": "ر.س",
        "locale": "ar",
        "is_rtl": true
...
12. Does this feature require :
   ...
   -  shimmer loading ?
shimmer loading iwnt this 

13. Any special logic or business rule that should be considered?
عايز الديزاين للى معايا match الداتا للى راجعة لو فية ناقص ضيفة لو راجعة null اخفى الجزء بتاعة لو فية زيادة من الداتا من الريكويست ضيفها 

download_invoice_screen.dart#L59-65
 

download_invoice_screen.dart#L68-76
 
                       

download_invoice_screen.dart#L79
