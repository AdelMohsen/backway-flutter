...
7. Example success JSON?
{
    "success": true,
    "data": [
        "https://greenhub.sa-fvs.com/assets/banner.png",
        "https://greenhub.sa-fvs.com/assets/1.png"
    ]
}
8. Example error JSON?
{
    "message": "The section field is required.",
    "errors": {
        "section": [
...
10. Post-error behavior?
    ...
    - Stay on screen?
    - Reset form?
  Show message and relode button to relode icon 
