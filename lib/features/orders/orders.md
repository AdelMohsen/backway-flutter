@orders  You are an autonomous senior Flutter engineer working inside an EXISTING production Flutter project.
...
inside  this  module @orders
3. Endpoint constant name? (to add in api_names.dart)
/customer/orders?page=1&per_page=10&status=in_progress
    ...
    "data": [
        {
            ...
            "pricing": {
                ...
                "vat_amount": "19.50",
                "platform_fee": "13.00",
                "driver_earnings": "117.00"
            },
            "scheduled_at": null,
            "accepted_at": "2026-03-09T17:43:02.000000Z",
            "picked_up_at": null,
            "delivered_at": null,
            "cancelled_at": null,
            "driver": {
            ...
            "negotiations": [
                {
                    ...
                    "status": "accepted",
                    "status_label": "negotiation.status.accepted",
                    "created_at": "2026-03-09T15:16:04.000000Z",
                    "updated_at": "2026-03-09T17:43:02.000000Z",
                    "driver": {
                        "id": 338,
                        "name": "سائق اختبار كامل",
                        "phone": "966507654322",
...
orders_tab_widget.dart#L28
 
new

orders_tab_widget.dart#L29
 
in_progress

orders_tab_widget.dart#L30
 
completed 

order_header_row.dart#L30-41
 
                "avatar": "https://greenhub.sa-fvs.com/assets/dashboard/Ellipse%2030.png"

order_header_row.dart#L55
 
this             "order_number": "ORD-20260309-4083D2",

order_status_chip.dart#L1-66
...
order_location_timeline.dart#L108
 
           "address": "الرياض - حي العليا",

order_location_timeline.dart#L128
 
      "address": "الرياض - حي الملقا",

details_order.dart#L44-56
 
    "final_price": "149.50",

details_order.dart#L58-66
 
    "name": "دراجة نارية",
                            "name_ar": "دراجة نارية",
                            "name_en": "Motorcycle",

details_order.dart#L68-76
