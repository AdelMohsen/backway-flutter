...
6. Request type:
   ...
   - Query parameters?
   - Path parameters?
title  and details thos text and image file
7. Example success JSON?
{
    ...
    "data": {
        ...
        "title": "test",
        "details": "test",
        "image": "https://greenhub.sa-fvs.com/storage/complaints/ea7hccInNaJU9lSq5w8uXKAnsqLyrFlGfnL18efA.png",
        "created_at": "2026-03-01T16:23:13.000000Z",
        "updated_at": "2026-03-01T16:23:13.000000Z"
    }
}
...
11. Does this feature require:
   ...
   - Infinite scroll?
Multipart upload
12. Any special logic or business rule that should be considered?عايز عن رفع الصورة ممكن تبقى صورة  امتدادا مختلف ممكن من الاستوديو او اكاميرا 

complaint_image_upload.dart#L10
 هندل كل حالات فى فع الصورة وكمان عشان لو حجمها اكبر من 3 ميجا اظهرلة مسادج حجم الصورة كبير 
